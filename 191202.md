...
1. Créer une fonction python index qui prend un entier et un tableau d'entiers et qui rend un tableau contenant les doubles des nombres du tableau précédent.
